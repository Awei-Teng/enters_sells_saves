<template>
				...
				<div class="main-right">
					<div class="serach">
						...
						@click="test" class="btn btn-info" style="float: right; margin-right: 1px;">新增</button>-->
							...
							<Button type="success" size="small" @click="show_addBrand">添加品牌</Button>
						</div>
					</div>
					<div class="table-box">
		...
		<Modal width='500' v-model="modal_addBrand" title="添加品牌">
			<Form ref="arg_addBrand" :model="arg_addBrand" :rules="rule_addBrand" :label-width="90">
				<Form-item label="品牌名称" prop="brandName">
					<Input v-model="arg_addBrand.brandName" placeholder="请输入品牌名称"></Input>
				</Form-item>
				<Form-item label="品牌描述" prop="remake">
					 <Input v-model="arg_addBrand.remake" type="textarea" :rows="4" placeholder="请输入品牌描述"></Input>
				</Form-item>
			</Form>
			<div slot="footer" style="text-align: center;">
				<Button type="success" size='large' @click="up_addBrand">确定</Button>
				<Button type="info" size='large' @click="modal_addBrand=false">取消</Button>
			</div>
		</Modal>
									...
									h('Button', {
										...
										on: {
											click: () => {
												...
												this.now_id = params.row.brandId
											}
										}
									}, '编辑'),
									h('Button', {
										...
										on: {
											click: () => {
												this.up_delete(params.row.brandId)
											}
										}
									}, '删除')
								]);
